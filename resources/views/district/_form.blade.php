@if(isset($item))
    {!! Form::open(['url' => route('district-update', $item['id']), 'class'=> 'ajax', 'method' => 'post', 'id' => 'update-district-form']) !!}
@else
    {!! Form::open(['url' => route('district-store'), 'class'=> 'ajax', 'method' => 'post', 'id' => 'create-district-form']) !!}
@endif
<div class="row">
    {{ csrf_field() }}
