        ...
        <div class="card text-left">
            ...
            <div class="card-body detail-page">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h4 class="card-title mb-2">Place Details</h4>
                    </div>
                    <div class="col-md-6">
                        <div class="dropdown">
                            <div class="user align-self-end text-right">
                                <a href="{{route('places')}}" class="btn btn-primary btn-rounded">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="table office-table-view">
                    <ul class="list-group">
                        ...
                        <div class="office-detail-row">
                            <li class="list-group-item width-50"><strong>District</strong></li>
                            <li class="list-group-item width-50">{{$item->district_id ? $item->district->name : ''}}</li>
                        </div>
                        <div class="office-detail-row">
                        ...
                        <div class="office-detail-row">
                            ...
                            <li class="list-group-item width-50">
                                <img height="50" src="{{ asset('public/'.$item->image_url ?? null) }}" class="rounded-circle m-0 avatar-sm-table"></li></li>
                        </div>
                    </ul>
                </div>
            </div>
